...
import src.model.EmptySlotComponent;
import src.model.RookChessComponent;
import src.model.KingChessComponent;
import src.model.KnightChessComponent;
import src.model.BishopChessComponent;
import src.model.QueenChessComponent;
import src.model.PawnChessComponent;
...
//                        break;
    ...
    public String getChessboardGraph(){
        ...
        for (int i=0;i<8;i++){
            s1.append(chessComponents[0][i].getChessName());
        }
        for (int i=0;i<8;i++){
            s2.append(chessComponents[1][i].getChessName());
        }
        for (int i=0;i<8;i++){
            s3.append(chessComponents[2][i].getChessName());
        }
        for (int i=0;i<8;i++){
            s4.append(chessComponents[3][i].getChessName());
        }
        for (int i=0;i<8;i++){
            s5.append(chessComponents[4][i].getChessName());
        }
        for (int i=0;i<8;i++){
            s6.append(chessComponents[5][i].getChessName());
        }
        for (int i=0;i<8;i++){
            s7.append(chessComponents[6][i].getChessName());
        }
        for (int i=0;i<8;i++){
            s8.append(chessComponents[7][i].getChessName());
        }
        ...
        String res= String.format("%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s",s1.toString(),s2.toString(),s3.toString(),s4.toString(),s5.toString(),s6.toString(),s7.toString(),s8.toString(),s9.toString());
        return res;
    }
